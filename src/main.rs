...
const OBSTACLE_RANDOM_VERTICAL_OFFSET: f32 = 40.0;
const OBSTACLE_GAP_SIZE: f32 = 20.0;
const OBSTACLE_SPACING: f32 = 250.0;
...
pub fn spawn_obstacles(
    ...
    for i in 0..OBSTACLE_AMOUNT {
        ...
        let x_position = window_width / 2. + OBSTACLE_SPACING * i as f32;
        spawn_obstacle(
...
pub fn update_obstacles(
    ...
    for (obstacle, mut transform) in obstacle_query.iter_mut() {
        ...
        if transform.translation.x + OBSTACLE_WIDTH / 2. < -game_manager.window_dimensions.x / 2. {
